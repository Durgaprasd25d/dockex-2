...
VERCEL_API_URL = "https://dockex-2-9kaz.vercel.app/api/upload"
...
print("=" * 80)
print(f"       VERCEL LIVE API OCR TEST SUITE FOR 6 CARDS       ")
print(f"       Target URL: {VERCEL_API_URL}")
print("=" * 80)
...
for idx, tc in enumerate(test_cases, 1):
    ...
    print(f"Uploading: {tc['file']} -> {VERCEL_API_URL}")
...
print("\n" + "=" * 80)
print(f"VERCEL TEST SUMMARY: TOTAL: {len(test_cases)} | PASSED: {passed} | FAILED: {failed}")
print("=" * 80)
